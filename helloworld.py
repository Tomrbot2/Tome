...
# Pembatas Script #
                                ...
                                string = text.replace("autojoin set ","")
                                settings["autoReject"]["members"] = int(string)
                                client.sendMessage(to,"Success Set Autojoin to {} Members.".format(str(string)))
                            elif cmd == "me":
                                ...
                                client.sendMessage(to, "success reject %i Invitation" % len(reject))
                            elif cmd == "groups pending":
                                ...
                                ret_ += "\n\nUsage : {}Reject #num".format(setKey)
                                client.sendMessage(to, str(ret_))
